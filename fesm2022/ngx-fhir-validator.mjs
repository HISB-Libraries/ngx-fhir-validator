...
import { Injectable, Inject, input, output, signal, ElementRef, ViewChild, Component, NgModule } from '@angular/core';
...
class ValidatorConstants {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: ValidatorConstants, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: ValidatorConstants }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: ValidatorConstants, decorators: [{
            type: Injectable
        }] });
...
class EnvironmentHandlerService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: EnvironmentHandlerService, deps: [{ token: 'serverBaseUrl' }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: EnvironmentHandlerService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: EnvironmentHandlerService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class FhirValidatorService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: FhirValidatorService, deps: [{ token: i1.HttpClient }, { token: i2.MatSnackBar }, { token: EnvironmentHandlerService }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: FhirValidatorService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: FhirValidatorService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class NgxFhirValidatorComponent {
    constructor(fhirValidatorService) {
        ...
        this.validatorTitle = input('', ...(ngDevMode ? [{ debugName: "validatorTitle" }] : []));
        this.validationResultsExpanded = input(false, ...(ngDevMode ? [{ debugName: "validationResultsExpanded" }] : [])); // Validation results details initial state
        this.resultDetailsExpandBtnShown = input(true, ...(ngDevMode ? [{ debugName: "resultDetailsExpandBtnShown" }] : [])); // Show/hide Expand Validation Results btn
        this.formatResourceBtnShown = input(false, ...(ngDevMode ? [{ debugName: "formatResourceBtnShown" }] : [])); // Show/hide Format Resource btn
        this.clearValidatorBtnShown = input(true, ...(ngDevMode ? [{ debugName: "clearValidatorBtnShown" }] : [])); // Show/hide Clear Validator btn
        this.submitBtnShown = input(true, ...(ngDevMode ? [{ debugName: "submitBtnShown" }] : [])); // Show/hide Submit btn
        this.exportResultsButtonShown = input(true, ...(ngDevMode ? [{ debugName: "exportResultsButtonShown" }] : []));
        this.submitBtnTitle = input('Submit', ...(ngDevMode ? [{ debugName: "submitBtnTitle" }] : [])); //The submit button title. "Submit" is generic name and other apps may want to change it
        this.validationInputFormat = input({ format: 'json', accepts: '.json' }, ...(ngDevMode ? [{ debugName: "validationInputFormat" }] : []));
        this.maxFileSize = input(250000, ...(ngDevMode ? [{ debugName: "maxFileSize" }] : [])); // Max allowed file size is 250KB
        this.submitBtnAlignment = input('right', ...(ngDevMode ? [{ debugName: "submitBtnAlignment" }] : [])); // The default location for the Submit btn
        this.cancelValidationBtnShown = input(true, ...(ngDevMode ? [{ debugName: "cancelValidationBtnShown" }] : []));
        this.buttonTxtColor = input('white', ...(ngDevMode ? [{ debugName: "buttonTxtColor" }] : []));
        this.buttonBackgroundColor = input('#4858B8', ...(ngDevMode ? [{ debugName: "buttonBackgroundColor" }] : []));
        this.exportValidationResultsBtnName = input('Export Results (.zip)', ...(ngDevMode ? [{ debugName: "exportValidationResultsBtnName" }] : []));
        this.ig = input(undefined, ...(ngDevMode ? [{ debugName: "ig" }] : []));
        this.onValidation = output();
        this.onApiError = output();
        this.onResourceContentChanged = output();
        this.onExportValidationResults = output();
        this.apiResponse = signal(null, ...(ngDevMode ? [{ debugName: "apiResponse" }] : []));
        ...
        this.lines = 1;
        this.width = 0;
        this.igList = signal([], ...(ngDevMode ? [{ debugName: "igList" }] : []));
        this.igNameList = [];
        this.igVersionList = [];
        this.localResultDetailsExpanded = true; // Local state for expand/collapse button
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: NgxFhirValidatorComponent, decorators: [{
            type: Component,
        ...
        }], ctorParameters: () => [{ type: FhirValidatorService }], propDecorators: { validatorTitle: [{ type: i0.Input, args: [{ isSignal: true, alias: "validatorTitle", required: false }] }], validationResultsExpanded: [{ type: i0.Input, args: [{ isSignal: true, alias: "validationResultsExpanded", required: false }] }], resultDetailsExpandBtnShown: [{ type: i0.Input, args: [{ isSignal: true, alias: "resultDetailsExpandBtnShown", required: false }] }], formatResourceBtnShown: [{ type: i0.Input, args: [{ isSignal: true, alias: "formatResourceBtnShown", required: false }] }], clearValidatorBtnShown: [{ type: i0.Input, args: [{ isSignal: true, alias: "clearValidatorBtnShown", required: false }] }], submitBtnShown: [{ type: i0.Input, args: [{ isSignal: true, alias: "submitBtnShown", required: false }] }], exportResultsButtonShown: [{ type: i0.Input, args: [{ isSignal: true, alias: "exportResultsButtonShown", required: false }] }], submitBtnTitle: [{ type: i0.Input, args: [{ isSignal: true, alias: "submitBtnTitle", required: false }] }], validationInputFormat: [{ type: i0.Input, args: [{ isSignal: true, alias: "validationInputFormat", required: false }] }], maxFileSize: [{ type: i0.Input, args: [{ isSignal: true, alias: "maxFileSize", required: false }] }], submitBtnAlignment: [{ type: i0.Input, args: [{ isSignal: true, alias: "submitBtnAlignment", required: false }] }], cancelValidationBtnShown: [{ type: i0.Input, args: [{ isSignal: true, alias: "cancelValidationBtnShown", required: false }] }], buttonTxtColor: [{ type: i0.Input, args: [{ isSignal: true, alias: "buttonTxtColor", required: false }] }], buttonBackgroundColor: [{ type: i0.Input, args: [{ isSignal: true, alias: "buttonBackgroundColor", required: false }] }], exportValidationResultsBtnName: [{ type: i0.Input, args: [{ isSignal: true, alias: "exportValidationResultsBtnName", required: false }] }], ig: [{ type: i0.Input, args: [{ isSignal: true, alias: "ig", required: false }] }], onValidation: [{ type: i0.Output, args: ["onValidation"] }], onApiError: [{ type: i0.Output, args: ["onApiError"] }], onResourceContentChanged: [{ type: i0.Output, args: ["onResourceContentChanged"] }], onExportValidationResults: [{ type: i0.Output, args: ["onExportValidationResults"] }], inputRef: [{
                type: ViewChild,
...
class NgxFhirValidatorModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: NgxFhirValidatorModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.1", ngImport: i0, type: NgxFhirValidatorModule, declarations: [NgxFhirValidatorComponent], imports: [CommonModule,
            BrowserModule,
    ...
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: NgxFhirValidatorModule, providers: [
            ValidatorConstants,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.1", ngImport: i0, type: NgxFhirValidatorModule, decorators: [{
            type: NgModule,
            args: [{ declarations: [
